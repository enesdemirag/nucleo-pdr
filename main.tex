...
% Ertuğrul: Bence Nucleo diyelim, ismi gibi.
% o zaman bu yaziyi komple gozden gecirip degistirelim.
% bu arada tum footnotelari sildim sadece hyperlink yaptim bazilarina
...
\paragraph{} İTÜ ROV Takımı ve İTÜ AUV Takımı'nın kurucu üyeleri olarak her zaman açık kaynaklı çalışarak su altı sistemleri topluluğuna fayda sağladık. Geçtiğimiz yıllarda geliştirilen araçlarımız ile ilgili tüm mekanik-elektronik tasarımlar ve yazılımlar GitHub adresimizde bulunmaktadır. % olaya açıklık getirmeye çalıştım, silebiliriz
...
\paragraph{} Takım üyeleri İstanbul Teknik Üniversitesi dördüncü sınıf öğrencilerinden oluşmaktadır. Takım danışmanı Ar. Gör. Mehmet Ozan Şerifoğlu'dur.
...
\paragraph{} Takım üye sayısının az olması nedeniyle, görev dağılımı yapılmış olsa dahi tüm üyelerin aracın her aşamasında ortak emeği olacaktır. Her üyenin bireysel olarak sorumlu olduğu görevler bulunmaktadır. Ekip üyelerinden Enes Demirağ takımın genel organizasyonu, görüntü işleme ve haberleşme sistemlerinden, Sencer Yazıcı otonom navigasyon ve kontrolör tasarımından, Ege Saygılı mekanik tasarım ve üretimden, Sinan Ertuğrul Yıldırım elektronik devre tasarımı ve güç sistemlerinden sorumludur.


% Bunun arkaplani silebilirim ama o zaman yazilar watermark ile karisabilir. nasil olsun?
\begin{figure}[hbt!]
\centering
...
\begin{figure}[hbt!]
\centering
\includegraphics[width=1\textwidth]{images/2160x2160_alpha2.png}
...
\begin{figure}[hbt!]
\centering
\includegraphics[width=1\textwidth]{images/SID.png}
...
\begin{figure}[hbt!]
\centering
\includegraphics[width=0.6\textwidth]{images/pre_oring.png}
\caption{Sistem Entegrasyon Diyagramı}
\label{fig:oring}
\end{figure}
...
\includegraphics[width=1\textwidth]{moment-removed.png}
 \end{adjustbox}
...
\begin{figure}[hbt!]
\centering
\includegraphics[width=1\textwidth]{flowchart-v2.png}
...
% Ertuğrul: Bu güvenlik kısmı çok sizli bizli olmuş bunu düzeltir misiniz saat 4:19 uykum geldi benim.
\paragraph{} Aracın tasarımı gibi teknik, üretim ve montaj gibi pratik işlerin yanı sıra en büyük öncelik iş güvenliği ve emniyetdir. Testlerde ve atölye çalışmalarında öncelik, çalışmak için güvenli ve konforlu alanı oluşturmak olacaktır. Atölye çalışmalarımızda kişisel koruyucu ekipmanlar olan gözlük, eldiven, maske gibi ekipmanların kullanılmasının yanında atölyemizde acil göz banyosu ve ilk yardım kiti bulundurmayı da ihmal etmeyeceğiz.

\paragraph{}Aracın tasarımı gibi teknik, üretim ve montaj gibi pratik işlerin yanı sıra en büyük öncelik iş güvenliği ve emniyetdir. Testlerde ve atölye çalışmalarında öncelik, çalışmak için güvenli ve konforlu alanı oluşturmak olacaktır. Atölye çalışmalarımızda kişisel koruyucu ekipmanlar olan gözlük, eldiven, maske gibi ekipmanların kullanılmasının yanında atölyemizde acil göz banyosu ve ilk yardım kiti bulundurmayı da ihmal etmeyeceğiz.

\paragraph{}Aracın üzerindeki motorların yerleşimi dışarıdan zarar gelmeyecek ve dışarıya zarar vermeyecek şekilde konumlandırılmıştır. Bunların yanı sıra, aracın üzerinde kullanılacak tüm plastik kelepçeler kullanıcılara zarar veremeyecek şekilde tıraşlanacak ve aracın üzerinde herhangi bir sivri uç bırakılmayacaktır. Aracın su altında herhangi bir sorunda karşılaşılması durumunda yer istasyonunda bulunan acil durdurma butonu sayesinde aracın hızlı bir şekilde durdurulma imkanı bulunmaktadır. Dağıtım hatlarında uygun sigortalar ve koruma devreleri de kullanılacaktır.
...
\begin{table}[hbt!]
\centering
\includegraphics[width=1\textwidth]{images/butce-final.png}
\caption{Bütçe}
\label{fig:butce}
\end{table}
