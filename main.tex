...
% ya şu resimler neden hep aşağı kayıyor.
\begin{figure}[hbt!]
\centering
...
\paragraph{} Araç uzaktan kontrol ve otonom olmak üzere iki farklı modda çalışabilecektir. algoritma 
...
\label{fig:gui}
\end{figure}
\subsubsubsection{GUI} % bunu üste almak gerekmez mi?
% GUI yerine Dış Arayüz (GUI) mi desek rapor taslağına ve türkçeye daha uygun olur??
% NEDEN RESIMLER DOKUMANIN SONUNA KAYIYOR?? NEDEEENNNN ?
...
% Ozgunluk hakkinda her alandan birer cumle ile bir paragraf yazilacak
