...
\paragraph{} Nucleo, İstanbul Teknik Üniversitesi Elektrik-Elektronik Fakültesi bünyesindeki farklı bö-lümlerden dört son sınıf öğrencisinin bir araya gelerek uzaktan kumandalı su altı aracı (ROV) geliştirmek üzere kurduğu bir proje takımıdır.

\paragraph{} Takım üyeleri 2017 yılından bu yana İTÜ ROV Takımı ve İTÜ AUV Takımı bünyesinde zorlu çalışmaların ve edinilen tecrübelerin ardından yeni bir araç üreterek Teknofest Su altı Sistemleri Yarışması'nda tecrübelerini ortaya koymayı amaçlamaktadır.

\paragraph{} Geliştirilecek araç, su altında yüzeydeki yer istasyonundan bir pilotun kontrolü ile veya tamamen otonom olarak çeşitli görevleri yapabilecektir. Araç, Teknofest Su altı Sistemleri Yarışması’nın beklentilerini amaçlanan maksimum başarı düzeyinde gerçekleştirmek üzere tasarlanacak ve üretilecektir. Takım, belirli görevlere odaklanmak üzere mekanik, elektronik, ve yazılım olmak üzere üç alt ekibe bölünmüştür. Araç, görev gereksinimlerini yerine getirirken hem minimum boyut hem de ağırlık optimizasyonu ile tasarlanacaktır.

\paragraph{} Araç mümkün olduğunca üniversite bünyesinde üretilebilecek şekilde tasarlanacaktır ve üretim maliyetini en aza indirmek için ekibimizdeki üyelerin aynı zamanda çalışmakta olduğu İTÜ Gemi İnşaatı ve Deniz Bilimleri Fakültesi'ndeki Otonom Su Altı Aracı (AUV) Takımı'nın çalışma odası kullanılacaktır.
...
\paragraph{} Tüm üyelerimiz İstanbul Teknik Üniversitesi, Elektrik-Elektronik Fakültesi 4. sınıf öğrencisidir. Takım danışmanı Gemi İnşaatı ve Deniz Bilimleri Fakültesi Araştırma Görrevlisi Mehmet Ozan Şerifoğlu'dur.
...
\paragraph{} Araç üzerinde beş eksende hareket özgürlüğü sağlaması için altı adet fırçasız motorlu itici bulunmaktadır (Şekil \ref{fig:itici}). İticiler açık kaynaklı BlueRobotics T200 pervane tasarımı modifiye edilerek en baştan takım tarafından tasarlanmıştır. Aracın elektronikleri su geçirmez akrilik bir kap içerisinde bulunmaktadır. Su geçirmez kaba kablo girişleri/çıkışları, kapak sistemleri vs. tüm su girişi olabilecek açıklıklarda o-ring conta sistemi kullanılmıştır.\cite{BOOK:o-ring} Aracın şasisi akrilik plastik (PMMA) malzemeden modüler bir yapıda tasarlanmıştır. Bu modülerlik sayesinde araç üzeri yapılması istenecek herhangi bir modifikasyon kolaylaştırılmıştır.
...
\includegraphics[width=1\textwidth]{inlinesplice.jpg}
 \end{adjustbox}
\caption{Reçine İle Korunmuş Bir Kablo Eki - \href{https://www.3m.com/3M/en_US/company-us/all-3m-products/~/3M-Scotchcast-Flexible-Splice-Kit-82-F2-Non-shielded-1-5-kV-Non-Shielded-Dry-and-Wet-Cables-Single-and-Multiple-Conductor-Portable-Cable-10-boxes-carton/?N=5002385+3294756698&rt=rud
}{3m.com}}
...
\paragraph{} Araç içinde kullanılan ve ekip üyeleri tarafından çizilen elektronik kartlar, diğer baskı devre üreticilerine nazaran daha uygun fiyatlı olması nedeniyle Çin'de ürettirilecektir. Komponentlerin lehimlenmesi ekip üyeleri tarafından yapılacaktır.

\paragraph{} Aracın şasisini oluşturan akrilik parçalar lazer kesim yöntemi ile işlenecektir. Bu yöntem ve akrilik malzeme seçimi üretim kolaylığı ve ekonomik oluşundan dolayı tercih edilmiştir. Su geçirmez kabın conta yataklı flanşı aluminyumdan manuel torna da talaşlı imalat yöntemiyle işlenecektir. 3B plastik parçalar 3B yazıcılar yardımıyla basılacaktır.
...
\begin{figure}[hbt!]%
    \centering
    \subfloat[Korozyona Uğramış Motor Örneği]{{\includegraphics[width=6cm]{korozyon.png} }}%
    \qquad
    \subfloat[Korunmuş Motor - \href{https://bluerobotics.com/store/thrusters/t100-t200-thrusters/t100-thruster-core/}{bluerobotics.com}]{{\includegraphics[width=7cm]{potted.png} }}%
...
\paragraph{} Araç; genişliği 32cm, yüksekliği 34cm, uzunluğu ise 46cm olacak şekilde tasarlanmıştır. Aracın ağırlığı ve yüzerliği yaklaşık 6.8kg'dır, bu sayede araç hafifçe pozitif bir yüzerliğe sahiptir, herhangi bir kontrol kaybında araç hafif yüzerliği sayesinde yüzeye çıkacak ve sudan geri alınabilecektir. 
...
\paragraph{} Raspberry Pi tarafından işlenecek görüntü, bir USB kamera vasıtasıyla alınacaktır. Araçta; aracın suyun ne kadar altında durduğunu anlaması adına bir basınç sensörü, açısal kontrolünün sağlanması için ataletölçer, istenilen görevleri gerçekleştirebilmesi adına bir tutucu kol bulunacaktır. Tutucu kol yine STM32 tarafından bir motor sürücü vasıtasıyla kontrol edilecektir.
...
\paragraph{} Takım bünyesinde geliştirilen yazılımın kullanılması hedeflenmektedir. Takımda geliştirilen yazılım, modüler bir altyapı içerdiğinden, kolayca geliştirilebilecek ve entegre edilebilecektir.
...
\paragraph{} Son olarak tüm bu verilerin ve kontrol sistemlerinin, temel karar verme mekanizmasının bulunduğu ana bilgisayara iletilmesi için istenirse Ethernet, Ethernet'te haberleşme sorunu ortaya çıkarsa UART kullanılabilir. Gömülü sistem bu iletişim yöntemlerinin hangisinin aktif olduğunu belirleyerek birinden ötekine dinamik olarak geçebilmektedir. Gömülü yazılım, tüm bunları \href{https://www.ros.org}{ROS} topic ağı üzerinde gerçekleştirmekte olup herhangi bir topic'i dinleyebilip, herhangi bir topic'e veri aktarımı yapabilmektedir. 

\newpage

\subsubsubsection{Merkezi Bilgisayar ve Karar Mekanizması Sistemi}

\paragraph{} Aracın temel fonksiyonları gömülü yazılım tarafından STM32 üzerinde gerçekleştirilirken, görev akışını ve üst seviye hesaplamaları gerçekleştirecek olan bilgisayar, Raspberry Pi 3, Ethernet ve ya UART üzerinden STM32 ile haberleşerek temel fonksiyonların üst seviye yazılımlar ile iletişimini sağlar. Üst seviye yazılımlarda, ROS ağı üzerinde çalışacak olan yazılımlar, görüntü işleme ve HD USB Kamera görüntüsünün yüzeye aktarılması bulunur.
...
\begin{table}[hbt!]
\centering
\includegraphics[width=1\textwidth]{last-budget.png}
\caption{Bütçe}
\label{fig:butce}
\end{table}
